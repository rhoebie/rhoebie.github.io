...
const gradientStyles = {
  one: {
    ...
    border: 'border-[1px] border-[transparent] bg-clip-padding bg-origin-border',
...
const Card = forwardRef(({ children, variant = 'one', width = 'w-full', height = 'h-auto', className = '' }, ref) => {
  ...
  return (
    ...
    >
      <div className={`rounded-xl ${style.bg} w-full h-full ${style.border}`}>
        {children}
      </div>
    </div>
  );
